    ...
    return (
        ...
        <div className={'wrapper-right'}>
            <div className={'dashboard   '}>
                ...
                {/*   */}
                {/*</Row>*/}
                <Row className="m-0 mb-3  my-school py-3"  >
                    <Col><h3>Yangiliklar</h3></Col>
                    <div className={'d-flex flex-wrap  '}>
                        <Col xs={12} md={6} className={'p-2 ps-0'}>
                            <Card body  >
                                <h6>Create new individual survey</h6>
                                <p className="text-muted">Qorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                <Button variant={'outline-primary'} className={'d-block ms-auto btn-color'} style={{fontSize:'12px' ,letterSpacing:'1px'}}>Batafsil</Button>
                            </Card>
                        </Col>

                        <Col xs={12} md={6} className={'p-2 pe-0 '}>
                            <Card body  >
                                <h6>Create new individual survey</h6>
                                <p className="text-muted">Qorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                <Button variant={'outline-primary'} className={'d-block ms-auto btn-color'} style={{fontSize:'12px' ,letterSpacing:'1px'}}>Batafsil</Button>
